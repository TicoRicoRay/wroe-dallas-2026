...
const CUSTOMERS = [
  ...
  // --- Late additions (Sep 10 submissions) ---
  {
    name: 'TEKConcierge',
    headline: 'MSP Titan of the Southwest 2025 and DBJ Fast 50 back-to-back',
    detail: 'Richardson-based managed IT provider. 2025 MSP Titan of the Southwest, Dallas Business Journal Fast 50 in both 2025 and 2026, Inc. Regionals: Southwest in 2025 (#104) and 2026 (#81), Inc. 5000 four years running (2023 through 2026), Channel Partners MSP 501 (2025), and FDI Insider Managed Intelligence Provider of the Year for Richardson (2026).',
    readAs: 'TEKConcierge leadership team',
    photo: null,
    badge: 'HEADLINE WIN',
    implementer: 'Aaron Garcia',
  },
  {
    name: 'Hotchkiss Insurance',
    headline: 'Six consecutive years on Houston Business Journal Best Places to Work',
    detail: 'Houston and Dallas. Houston Business Journal Best Places to Work 2018 through 2023 (#11 medium company in 2023). Insurance Journal Best Agency to Work For Gold, South Central, in 2015 and 2019. Dallas Morning News Top 100 Places to Work in 2018 (#17 small company).',
    readAs: 'Hotchkiss Insurance leadership team',
    photo: null,
    badge: 'COMMUNITY WIN',
    implementer: 'Duke Revard',
  },
  {
    name: 'AMI Construction, Inc.',
    headline: 'Nashville Business Journal 2025 Fastest-Growing Companies, #10 in Middle Tennessee',
    detail: 'Nashville. Also a National Top 50 Contractor in four categories (paving, striping, pavement repair, and sealcoating) through the Pavement Maintenance and Reconstruction Top Contractor program.',
    readAs: 'AMI Construction leadership team',
    photo: null,
    badge: 'COMMUNITY WIN',
    implementer: 'Duke Revard',
  },
  {
    name: 'C1M',
    headline: '2025 Vistage Top Performer, 4.96 speaker average',
    detail: 'CEO John Arnott recognized as a 2025 Vistage Top Performer for his speaking work with Vistage member CEO peer groups.',
    readAs: 'John Arnott, CEO',
    photo: 'c1m_vistage.png',
    badge: 'COMMUNITY WIN',
    implementer: 'Amy Johannesen',
  },
  {
  ...
  },
  {
    ...
    readAs: 'Rebecca Silvestri, Publisher   \u00b7   Philip Silvestri',
    photo: 'local_profile_summit.jpg',
    badge: 'COMMUNITY WIN',
    implementer: 'Sandi Mitchell',
  },
  {
    name: 'Arts Fort Worth',
    headline: 'Heart of Gold 2026 raised the Philanthropist Award for Tarrant County Pearls',
    detail: 'Fort Worth nonprofit. Heart of Gold event on February 27, 2026 recognized the Tarrant County Pearls Chapter of The Links, Incorporated with the Philanthropist Award, presented by Executive Director Wesley Gentle.',
    readAs: 'Wesley Gentle, Executive Director',
    photo: 'arts_fort_worth.jpg',
    badge: 'COMMUNITY WIN',
    implementer: 'Sandi Mitchell',
  },
  {
    name: 'Catco',
    headline: 'Featured in the new Issues book, record calendar year, and patents pending',
    detail: 'Featured in the newly released EOS Issues book. Trailing-12-month orders broke the record three times. Record Q4, record Q1, record first half, record calendar year, and three record calendar months. Revenue posted a record Q2, record first half, and four record calendar months. Two patents pending plus a third application in progress. Two new leadership team hires with one more in recruitment.',
    readAs: 'Travis Richards',
    photo: null,
    badge: 'HEADLINE WIN',
    implementer: 'Jill Young',
  },
];
