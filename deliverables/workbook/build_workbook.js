...
const SPEAKER_SESSIONS = [
  ...
  { session_title: 'Rollout, Reworked: Your Plan for Running EOS® Company-Wide', speaker: 'Beth Fahey', title: 'Expert EOS Implementer®',
    ...
    reflection: {
      ...
      attribution: 'Rollout Troubleshooting Guide, Marisa Smith and Beth Fahey',
      questions: [
        'Could every person in your company explain your Core Values and Core Focus without notes? If not, who owns fixing that, and is it a Rock?',
        'Which Rollout stage are you actually in: Preparation, Launch, Integration, or Sustainability? What is the next NO on the tracker you need to turn into a YES?',
        'Which of the 10 troubleshooting issues is alive in your company right now? What is the root cause, not the symptom?',
        'Which of your managers would say EOS is being done to them? What did leadership do, or fail to do, that created that?',
      ],
    } },
